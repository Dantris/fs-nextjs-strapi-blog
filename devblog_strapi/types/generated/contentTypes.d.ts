...
export interface ApiInfoblocksAboutInfoblocksAbout extends Schema.SingleType {
  collectionName: 'infoblocks_abouts';
  info: {
    singularName: 'infoblocks-about';
    pluralName: 'infoblocks-abouts';
    displayName: 'infoblocks about';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    info_blocks: Attribute.Relation<
      'api::infoblocks-about.infoblocks-about',
      'oneToMany',
      'api::info-block.info-block'
    >;
    createdAt: Attribute.DateTime;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::infoblocks-about.infoblocks-about': ApiInfoblocksAboutInfoblocksAbout;
